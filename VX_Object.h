...
public:
	...
	inline void SetAmpBaseline(int Index, double Value) {pAmpBaseline[Index] = Value;} // nac: sets the material index here
	inline double GetAmpBaseline(int Index) const {return pAmpBaseline[Index];}
	inline void InitAmpBaselineArray(int Size) {pAmpBaseline = new double[Size];}

	inline void SetAmpResponse(int Index, double Value) {pAmpResponse[Index] = Value;} // nac: sets the material index here
	inline double GetAmpResponse(int Index) const {return pAmpResponse[Index];}
	inline void InitAmpResponseArray(int Size) {pAmpResponse = new double[Size];}
	// int getNumNuerons() {return NumNuerons;}
...
public:
	...
	inline void SetAmpBaseline(int Index, double Value) {Structure.SetAmpBaseline(Index,Value);} // nac: sets the material index here
	inline double GetAmpBaseline(int Index) const {return Structure.GetAmpBaseline(Index);}
	inline void InitAmpBaselineArray(int Size) {Structure.InitAmpBaselineArray(Size);}

	inline void SetAmpResponse(int Index, double Value) {Structure.SetAmpResponse(Index,Value);} // nac: sets the material index here
	inline double GetAmpResponse(int Index) const {return Structure.GetAmpResponse(Index);}
	inline void InitAmpResponseArray(int Size) {Structure.InitAmpResponseArray(Size);}
	// int getNumNuerons() {return Structure.getNumNuerons();}

	inline void SetSynapseWeight(int VoxelIndex, int SynapseIndex, double Value) {Structure.SetSynapseWeight(VoxelIndex, SynapseIndex, Value);} // nac: sets the material index here
	inline double GetSynapseWeight(int VoxelIndex, int SynapseIndex) const {return Structure.GetSynapseWeight(VoxelIndex, SynapseIndex);}
	// inline void InitSynapseWeightArray(int SizeVoxels, int SizeSynapses) {Structure.InitSynapseWeightArray(SizeVoxels, SizeSynapses);}
	inline int GetNumSynapses() const {return Structure.GetNumSynapses();}
